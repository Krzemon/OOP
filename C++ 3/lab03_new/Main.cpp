...
int main() {
    ...
    // możliwych do dodania w każdym z nich. Przekazujemy też odniesienie do firmy,
    // w ramach której tworzymy działy.
    Department d1("IT",10,&myCompany);
    Department d2("HR",3,&myCompany);
